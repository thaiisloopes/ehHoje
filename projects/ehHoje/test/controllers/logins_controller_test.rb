...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { description: @login.description, name: @login.name, picture: @login.picture }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { description: @login.description, name: @login.name, picture: @login.picture }
    assert_redirected_to login_path(assigns(:login))
  end
